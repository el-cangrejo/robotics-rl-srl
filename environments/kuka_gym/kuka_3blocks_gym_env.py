...
BUTTON_DISTANCE_HEIGHT = 0.28  # Extra height added to the blocks position in the distance calculation
...
class Kuka3BlocksGymEnv(SRLGymEnv):
    """
    ...
    def __init__(self, urdf_root=pybullet_data.getDataPath(), renders=False, is_discrete=True, multi_view=False,
                 name="kuka_3blocks_gym", max_distance=0.8, action_repeat=1, shape_reward=False, action_joints=False,
        ...
        super(Kuka3BlocksGymEnv, self).__init__(srl_model=srl_model,
    ...
    def step2(self, action):
        ...
        # p.setJointMotorControl2(self.blocks_uid[0], BUTTON_GLIDER_IDX, controlMode=p.POSITION_CONTROL, targetPosition=0.1)
